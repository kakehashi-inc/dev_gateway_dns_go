                ...
                <div>
                    <div className='flex items-center gap-2'>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setForm({ ...form, listen_addresses: e.target.value.split(',').map(s => s.trim()) })
                            }
                            className='flex-1 border rounded px-2 py-1 dark:bg-gray-700 dark:border-gray-600'
                        />
                    </div>
                    <p className={`${hintClass} ml-50`}>{t('settings.listenAddressesHint')}</p>
                </div>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setForm({
                                    ...form,
                                    upstream_dns_fallback: e.target.value.split(',').map(s => s.trim()),
                                })
                            }
                            className='flex-1 border rounded px-2 py-1 dark:bg-gray-700 dark:border-gray-600'
                        />
                    </div>
                    <p className={`${hintClass} ml-50`}>{t('settings.upstreamDnsHint')}</p>
                </div>
                ...
                <div>
                    <div className='flex items-center gap-2'>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setForm({ ...form, dns_query_history_size: parseInt(e.target.value) || 1000 })
                            }
                            className='flex-1 border rounded px-2 py-1 dark:bg-gray-700 dark:border-gray-600'
                        />
                    </div>
                    <p className={`${hintClass} ml-50`}>{t('settings.queryHistorySizeHint')}</p>
                </div>
                ...
                <div>
                    <div className='flex items-center gap-2'>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setForm({ ...form, access_log_retention_days: parseInt(e.target.value) || 7 })
                            }
                            className='flex-1 border rounded px-2 py-1 dark:bg-gray-700 dark:border-gray-600'
                        />
                    </div>
                    <p className={`${hintClass} ml-50`}>{t('settings.accessLogRetentionDaysHint')}</p>
                </div>
